...
export const getPersonalInfo = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, personalInfo, 'Personal info retrieved successfully'));
});

// Update personal info (upsert - create if doesn't exist)
export const updatePersonalInfo = asyncHandler(async (req, res) => {
    const { name, tagline, description, email, phone, location, social_links } = req.body;
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, personalInfo, 'Personal info updated successfully'));
});
...
export const deletePersonalInfo = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, null, 'Personal info deleted successfully'));
});
