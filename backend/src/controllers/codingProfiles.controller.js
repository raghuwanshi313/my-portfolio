...
export const getAllCodingProfiles = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, profiles, 'Coding profiles retrieved successfully'));
});
...
export const getCodingProfileById = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, profile, 'Coding profile retrieved successfully'));
});
...
export const createCodingProfile = asyncHandler(async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, profile, 'Coding profile created successfully'));
});
...
export const updateCodingProfile = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, profile, 'Coding profile updated successfully'));
});
...
export const deleteCodingProfile = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, null, 'Coding profile deleted successfully'));
});
